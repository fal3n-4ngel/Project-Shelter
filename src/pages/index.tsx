...
export default function Home() {
  return (
    <main className="w-11/12 center m-auto text-black items-center justify-center">
      <nav id="navbar" className=" sticky z-10 bg-white top-0 w-full   border-b-2 border-gray-600">
      ...
      <div className="flex flex-col border-2  border-black min-h-[100vh] relative ">
        ...
        <div
          id="aboutUs"
          className="flex min-h-8/10 border-b-[2px] border-black"
        >
          <div></div>
        ...
        <Marquee className="bg-red-500 text-white border-black border-b-2 text-3xl min-h-[4.5rem]" gradient={false} speed={40}>
          <h1>itin George D  <span className="px-4 ">•</span>  Rhon S George  <span className="p-x-4 mx-4">•</span>  Vinu B George  <span className="p-x-4 mx-4">•</span> Adithya T George  <span className="p-x-4 mx-4">•</span>  R</h1>
          <h1>itin George D  <span className="px-4 ">•</span>  Rhon S George  <span className="p-x-4 mx-4">•</span>  Vinu B George  <span className="p-x-4 mx-4">•</span> Adithya T George  <span className="p-x-4 mx-4">•</span>  R</h1>
          <h1>itin George D  <span className="px-4 ">•</span>  Rhon S George  <span className="p-x-4 mx-4">•</span>  Vinu B George  <span className="p-x-4 mx-4">•</span> Adithya T George  <span className="p-x-4 mx-4">•</span>  R</h1>
